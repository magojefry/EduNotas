...
const Header = () => {
  return (
    ...
    <>
        <header className="bg-sky-500 text-gray-600 body-font">
        <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
            ...
            <span className="ml-3 text-xl">Docente</span>
            </a>
            <nav className="md:ml-auto flex flex-wrap items-center text-base justify-center">
                <span className="ml-1 text-xl">Manuel salazar /</span>
                <p></p>
                <span className="ml-1 text-xl">Code:12457825</span>
